...
const CheckoutPage = () => {
  ...
  const makePurchase = async () => {
    ...
    try {
      ...
      toast.success("Enquiry & order placed successfully! Generating your invoice...");
      setTimeout(() => {
  ...
  return (
    <div className="bg-white">
      <SectionTitle title="Order Enquiry & Pro-Forma Invoice" path="Home | Cart | Enquiry & Invoice" />
          ...
          <div className="mx-auto max-w-lg lg:max-w-none">
              ...
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200/80 rounded-2xl p-5 shadow-sm">
                <div className="flex items-start">
                  <div className="flex-shrink-0">
                    <FaFileInvoice className="h-6 w-6 text-blue-600 mt-0.5" />
                  </div>
                  <div className="ml-3.5">
                    <h3 className="text-sm font-bold text-slate-900 flex items-center gap-2">
                      <span>No Upfront Payment Required</span>
                      <span className="text-[10px] uppercase tracking-wider font-semibold bg-emerald-100 text-emerald-700 px-2 py-0.5 rounded-full">
                        Instant Pro-Forma Invoice
                      </span>
                    </h3>
                    <div className="mt-1.5 text-xs text-slate-600 leading-relaxed space-y-1">
                      <p>
                        Submitting this form immediately registers your enquiry and generates an official pro-forma invoice with all items, quantities, and direct settlement / corporate wire details.
                      </p>
                      <p className="text-slate-500 font-medium">
                        You can review, print, or download your PDF invoice right on the next screen.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="mt-10 border-t border-gray-200 pt-6 ml-0">
              <button
                ...
                disabled={isSubmitting}
                className="w-full rounded-2xl border border-transparent bg-blue-600 px-8 py-4 text-base font-bold text-white shadow-lg shadow-blue-500/25 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 sm:order-last disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center justify-center gap-2.5 transition-all"
              >
                <FaFileInvoice className="text-lg" />
                <span>{isSubmitting ? "Submitting Enquiry & Generating Invoice..." : "Place Order & Generate Invoice"}</span>
              </button>
            </div>
          </div>
        </form>
